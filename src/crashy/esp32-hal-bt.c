// Copied from:
//
//      Arduino15/packages/esp32/hardware/esp32/1.0.2/cores/esp32/esp32-hal-bt.c
//
// But with the patch from:
//
//      https://github.com/espressif/arduino-esp32/issues/2718#issuecomment-552213656
//
// To allow bluetooth stop and start without WDT kernel panic...
//
...
bool btStop(){
    ...
    if(esp_bt_controller_get_status() == ESP_BT_CONTROLLER_STATUS_INITED){
        ...
        // Patch from https://github.com/espressif/arduino-esp32/issues/2718#issuecomment-552213656
        log_i("inited");
